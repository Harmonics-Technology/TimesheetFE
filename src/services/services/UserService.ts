...
export class UserService {
     ...
     * @throws ApiError
     */
    public static listSupervisorsAndAdmins(
        clientId: string,
    ): CancelablePromise<UserViewListStandardResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/User/supervisors-admins/{clientId}',
            path: {
                clientId: clientId,
            },
        });
     ...
     * @throws ApiError
     */
    public static listClentAndSupervisors(
        clientId: string,
    ): CancelablePromise<UserViewListStandardResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/User/client-supervisors/{clientId}',
            path: {
                clientId: clientId,
            },
        });
     ...
     * @throws ApiError
     */
    public static addMemberToList(): CancelablePromise<BooleanStandardResponse> {
        return __request(OpenAPI, {
            method: 'POST',
